...
class RutaService implements RutaServiceInterface
{
  ...
  public function reordenarParadas(Ruta $ruta, array $orden): void
  {
    // Validación de negocio
    if (!in_array($ruta->estado, ['borrador', 'calculada'])) {
      throw new RuntimeException('Solo se pueden reordenar paradas de rutas editables');
    }

    // Actualizar orden secuencial
    $this->repo->actualizarOrdenParadas($ruta, $orden);
