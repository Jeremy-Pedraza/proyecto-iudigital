...
class StoreRutaRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      'hora_inicio_jornada' => 'required|date_format:H:i:s',
      'hora_fin_jornada' => 'required|date_format:H:i:s|after:hora_inicio_jornada',
  ...
  public function withValidator($validator): void
  {
    $validator->after(function ($validator) {
      ...
      if ($this->hora_inicio_jornada && $this->hora_fin_jornada) {
        ...
        // CORRECCIÓN: calcular desde inicio hasta fin
