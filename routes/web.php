...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('planificacion')->as('planificacion.')->middleware(['role:admin|Supervisor'])->group(function () {
        ...
        // Route::get('rutas/{ruta}/editor', [RutasController::class, 'editor'])->name('rutas.editor');  // UI drag&drop RF-04
        // Route::put('rutas/{ruta}/paradas/orden', [RutasController::class, 'reordenarParadas'])->name('rutas.paradas.reorden'); // RF-04
